...
{
  GtkWidget *page = hyscan_gtk_profile_db_new ("/etc");
...
{
  GtkWidget *page = hyscan_gtk_profile_hw_new ("/etc", self->priv->drivers);
...
{
  GtkWidget *page = hyscan_gtk_profile_offset_new ("/etc");
